...
class XTBClient {
    constructor() {
        ...
        this.accountBalance = 1000; // Default demo account balance
        this.trades = [];
        this.dailyStats = {
    ...
    login() {
        ...
        console.log('logged in as ' + process.env.XTB_USER_ID);
    }
    ...
    async executeTrade(signal, price) {
        console.log('attempting to execute a trade');
...
-------------------`);
    ...
    startStreaming() {
        ...
        console.log("executing stream command: " + JSON.stringify(streamSessionCmd));

        console.log("starting stream");
        this.sendCommand(streamSessionCmd);
        console.log("stream started");


        // this.sendCommand(checkSymbolsCmd);
    }
}
